...
class WebBrowserButtons:
    ...
    @staticmethod
    def open_tutorial():
        webbrowser.open("https://www.youtube.com/channel/UCbHqb15flW9W3Du601kK9uw")

    @staticmethod
    def open_discord():
        webbrowser.open("https://discord.gg/PKrR7gpP")
...
class WindowAspects:
    ...
    def nuke_options():
        ...
        main_info_frame = LabelFrame(main_frame, text="Settings", bg="black", fg="yellow")
        main_info_frame.grid(row=0, column=0, padx=2, pady=2)

        main_nuke_frame = LabelFrame(main_frame, text="Pannel", bg="black", fg="yellow")
        main_nuke_frame.grid(row=0, column=1, padx=2, pady=2)

        client_info_frame = LabelFrame(main_info_frame, text="Client", bg="black", fg="yellow")
        client_info_frame.grid(row=0, column=0, padx=2, pady=2)

        guild_info_frame = LabelFrame(main_info_frame, text="Server information", bg="black", fg="yellow")
        guild_info_frame.grid(row=1, column=0, padx=2, pady=2)

        tyclonie_tech_info_frame = LabelFrame(main_info_frame, text="Socks Info", bg="black", fg="yellow")
        tyclonie_tech_info_frame.grid(row=2, column=0, padx=2, pady=2)

        member_nuke_options_frame = LabelFrame(main_nuke_frame, text="Socks Banner", bg="red", fg="yellow")
        member_nuke_options_frame.grid(row=0, column=0, padx=2, pady=2)

        channel_options_frame = LabelFrame(main_nuke_frame, text="Socks Channels", bg="red", fg="yellow")
        channel_options_frame.grid(row=1, column=0, padx=2, pady=2)

        roles_nuke_options_frame = LabelFrame(main_nuke_frame, text="Socks Roles", bg="red", fg="yellow")
        roles_nuke_options_frame.grid(row=2, column=0, padx=2, pady=2)

        text_nuke_options_frame = LabelFrame(main_nuke_frame, text="Socks Spammer", bg="red", fg="yellow")
        ...
        guild_id.insert(0, "Server ID")

        developer_tag_label = Label(tyclonie_tech_info_frame, text="Developer: Sock", bg="black", fg="red")
        ...
        tutorial_button = Button(tyclonie_tech_info_frame, text="More Information",
                                 command=WebBrowserButtons.open_tutorial, bg="black", fg="green", width=17)
        tutorial_button.grid(row=3, column=0, padx=2, pady=2)

        github_button = Button(tyclonie_tech_info_frame, text="F.",
        ...
        def get_guild_data():
            ...
            server_owner_label = Label(guild_info_frame, text=f"Server Owner: {guild.owner}", bg="black", fg="red")
        ...
        get_guild_data_button = Button(guild_info_frame, text="Enter",
        ...
        ban_all_button = Button(member_nuke_options_frame, text="Ban All",
        ...
        kick_all_button = Button(member_nuke_options_frame, text="Kick All",
        ...
        delete_all_channels_button = Button(channel_options_frame, text="Wipe channels",
        ...
        delete_all_roles_button = Button(roles_nuke_options_frame, text="Wipe roles",
        ...
        spam_make_roles_button = Button(roles_nuke_options_frame, text="Spam roles",
        ...
        spam_role_name_entry.insert(0, "Role")

        spam_messages_button = Button(text_nuke_options_frame, text="Spam Messages",
        ...
        message_all_button = Button(text_nuke_options_frame, text="Sock DM", command=lambda: NukeOptions.message_all(
    ...
    def window():
        ...
        login_frame = LabelFrame(root, text="Bot ", bg="black", fg="yellow")
        login_frame.pack()
        token_entry = Entry(login_frame, bg="black", fg="red")
        token_entry.grid(row=0, column=0, padx=2, pady=2)
        token_entry.insert(0, "Token")
        bot_user_var = BooleanVar()
        bot_user = Checkbutton(login_frame, text="Discord Token?", variable=bot_user_var, bg="black", fg="blue")
...
def main():
    ...
    if latest_version > current_version:
        ...
        print("--------------------------------------------------------------")
        print(f"[CURRENT VERSION] Version: {str(current_version)}")
